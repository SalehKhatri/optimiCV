...
const Home = () => {
  return (
      <div className="flex justify-center h-[100vh] w-[100%] bg-gradient-to-b from-[#7693ef] to-[#7dfccf] via-[#78b1e6]">
        ...
        <div className="z-10 mt-28 flex flex-col items-center w-[90%] md:w-[100%] text-center">
          <h1 className="uppercase font-Bebas-Neue text-6xl w-[90%] md:w-[100%]  lg:text-7xl ">ARE YOU STRUGGLING TO GET SHORTLISTED?</h1>
